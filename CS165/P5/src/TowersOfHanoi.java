...
public class TowersOfHanoi {
    ...
    public static class Move {
    	...
    	public String toString() {
    		return "Disc" + disc + "to" + to + "from" + from + "auxiliary" + aux + "isCovered" + covered;
    	}
     ...
     *     <li> Make a recursive call to move the stack on the auxiliary pole back to the source pole.
     * </ol>
...
//    	if(disc == 0)
//    		
//    		move(disc, from, aux, to, true);
//    	else
//    		Move(disc, from, aux, to, false);
//
//    	
//    	
//    	
