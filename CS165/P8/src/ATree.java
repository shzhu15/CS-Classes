...
public abstract class ATree {
    ...
    /**
     * Parse an inorder expression into an {@link ArrayList} of tokens.
     * <p>
     * Reads a string that contains an inorder expression, and converts
     ...
     * @return expression in inorder order
     */
     ...
     * @param infix expression in inorder order
     ...
     * @return a string representing the expression inorder order.
     */
