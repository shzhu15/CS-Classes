...
public interface DrawInterface extends ActionListener
{
     ...
     *     gc.setFont(new Font(fonts[DrawPrimitives.rand(fonts.length)], DrawPrimitives.rand(2), DrawPrimitives.rand(35)));
     *         <ul>
     ...
     *                  the font.
     *         </ul>
     *         Set the font to "TimesRoman", BOLD, font size 15.
     ...
     * Use the graphics context to clear screen to middleColor.
     */
    void clear();
}
