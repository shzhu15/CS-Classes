 ...
 * to {@link PriorityQueue} as a reference implementation.
 * <p>
...
public class QueueTestProgram {
    ...
    public static void main(String[] args) {
        ...
        printFailedTests(hundred_thousand, PriorityQueue::new, (x) -> new Heap<>());
        // If this works for you, move on to the big leagues:
        // 1. change queue_max_size to 100
    ...
    public static void outtakes() {
        // The difference between a FIFO and a priority queue in behavior:
        printFailedTests(10000, ArrayBlockingQueue::new, (x) -> new Heap<>());
    }
